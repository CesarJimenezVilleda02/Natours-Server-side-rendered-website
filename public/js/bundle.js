        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'New account created successfully!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2VzYXI5MGNmciIsImEiOiJja3h5eDgwOWUyMDA0Mm9wZHR6cTc2OXh3In0.uGQyirxD1kwgrX9GUrM1QA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      ...
      anchor: 'bottom' // recordemos que las coordenadas las pusimos en una arreglo de 2 lng-lat
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51HiFIVFvjKAeBp1I8CDBmWjZ6tS9vh2gE3qxcQ4dwIgsP6iVbeEZDxCupThkRYivlLFxzX8jNt3Gk08qW45MAgkt00O6qIodne'); // 1 get the checkout session from the server --- endpoint
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('Payment could not be processed! Plase try again later.');
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('name').value;
    var email = document.getElementById('email').value; // debemos crear una forma

    var form = new FormData();
    form.append('name', name);
    form.append('email', email); // estamos recreando una multipart form data

    form.append('photo', document.getElementById('photo').files[0]); // ajax va a reconocer la forma como objeto por lo que no tendremos que csmbiar nada
